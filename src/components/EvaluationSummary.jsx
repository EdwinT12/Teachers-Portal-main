        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              <TrendingUp style={{ width: isMobile ? '20px' : '24px', height: isMobile ? '20px' : '24px', color: '#8b5cf6' }} />
            </div>
            <div>
              <p style={{
          ...
          <div style={{
            padding: '8px 12px',
            backgroundColor: getScoreColor(summaryData.overallScore) + '20',
            borderRadius: '8px',
        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              <Users style={{ width: isMobile ? '20px' : '24px', height: isMobile ? '20px' : '24px', color: '#3b82f6' }} />
            </div>
            <div>
              <p style={{
                fontSize: isMobile ? '11px' : '13px',
        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              <Award style={{ width: isMobile ? '20px' : '24px', height: isMobile ? '20px' : '24px', color: '#f59e0b' }} />
            </div>
            <div>
              <p style={{
                fontSize: isMobile ? '11px' : '13px',
