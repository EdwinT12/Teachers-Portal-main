...
const AttendancePage = () => {
  ...
  const saveAttendance = async () => {
    ...
    setSyncStep('Saving attendance to database...');
  ...
  return (
    <div style={{
      ...
      <div style={{
            ...
            >
              ...
              >
                ...
                <p style={{
                  ...
                  Your attendance data has been saved locally, but we couldn't sync it to Google Sheets. This might be due to an authentication issue.
                </p>
        ...
        {/* Rest of the component remains the same - Header, Students List, Save Button, Legend */}
        {/* Header */}
        <motion.div
